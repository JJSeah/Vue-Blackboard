<template>
  <div class="mainPanel">
    ...
    <div class="actionsPanel">
      ...
      <!-- Eraser select -->
      <panelToolIcon
        @click.native="toggleEraserSettings(); setBlackboardTool('eraser')"
        toolColor="white"
    ...
    <div class="actionSettingsPanel">
      ...
      <panelToolSettings v-if="isToolSettingsOpened">
        ...
        <div class="settingsActions" slot="settingsActions">
          <!-- Pencil select -->
          <panelToolIcon
            @click.native="setBlackboardTool('pencil')"
            :toolColor="toolColor"
          ...
          <!-- Brush select -->
          <panelToolIcon
            @click.native="setBlackboardTool('brush')"
            :toolColor="toolColor"
            :isActive="tool === 'brush'"
            icon="paint-brush"
          />
      ...
      <panelToolSettings v-if="isShapeSettingsOpened">
        ...
        <div class="settingsActions" slot="settingsActions">
          <!-- Circle select -->
          <panelToolIcon
            @click.native="setBlackboardTool('circle')"
            :toolColor="shapeColor"
          ...
          <!-- Square select -->
          <panelToolIcon
            @click.native="setBlackboardTool('square')"
            :toolColor="shapeColor"
          ...
          <!-- Triangle select -->
          <panelToolIcon
            @click.native="setBlackboardTool('triangle')"
            :toolColor="shapeColor"
          ...
          <!-- Line select -->
          <panelToolIcon
            @click.native="setBlackboardTool('line')"
            :toolColor="shapeColor"
            :isActive="tool === 'line'"
            icon="slash"
          />
...
export default {
  ...
  methods: {
    ...
    // Set tool
    setBlackboardTool(tool) {
      this.$store.dispatch("setBlackboardTool", tool);
    }
  },
  computed: {
    // Acitve
  ...
  mounted() {
    this.$store.dispatch("setBlackboardTool", "pencil");
  }
};
</script>
